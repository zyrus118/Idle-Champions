function ScriptHubExport()
    ...
    if classes~=nil then
      ...
      io.close(file)
      print("Export complete "..tostring(value).." Stop value ".. tostring(stopValue))
    else
  ...
  function mono_class_enumFields_ScriptHub(class, includeParents)
      ...
      repeat
        ...
        if (classfield~=nil) and (classfield~=0) then
          ...
          -- const includes functions or variables we aren't interested in, ignore them.
          --if(fields[index].isConst) then
